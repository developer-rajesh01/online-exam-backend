...
export const registerUser = async (req, res) => {
  try {
    ...
    const link = `${process.env.FRONTEND_URL}/onlineexaminationsystem/verify-email/${token}`;
    sendEmail(
      newUser.email,
...
export const forgotPassword = async (req, res) => {
  try {
    ...
    const resetLink = `${process.env.FRONTEND_URL}/onlineexaminationsystem/reset-password/${resetToken}`;
